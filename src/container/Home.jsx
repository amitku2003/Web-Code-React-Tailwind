...
export default function Home() {
  ...
  return (
    <>
        <div className={`w-2 ${isSideMenu ? "w-2": "flex-[.2] xl:flex:flex[.2]"} min-h-screen max-h-screen relative bg-secondary px-3 py-6 flex flex-col items-center justify-start gap-4 transition-all duratin-200 ease-in-out`}>
            {/* Toggle-btn */}
            ...
            <div className="overflow-hidden w-full flex flex-col gap-4">
                ...
                {/* Start Coding */}
                <Link to={"/newProject"}>
                    <div className="mt-10 px-6 py-3 flex items-center justify-center rounded-xl border border-gray-400 cursor-pointer group hover:border-gray-200">
                ...
                {/* {user && (
                    <Link to={"/home/projects"} className="flex items-center justify-center gap-6">
                        ...
                        <p className='text-xl text-primaryText'>Home</p>
                    </Link>
                )} */}
            </div>
        </div>
        <div className="flex-1 min-h-screen max-h-screen overflow-y-scroll h-full flex flex-col items-start justify-start px-4 md:px-12 py-4 md:py-12">
            <div className="w-full flex items-center justify-between gap-3">
                    <div className="bg-secondary w-full px-4 py-3 rounded-md flex items-center justify-center gap-3">
                        ...
                        <input type="text" value={searchTerm} className="flex-1 px-4 py-1 text-xl bg-transparent outline-none border-none text-primaryText placeholder:text-gray-600" placeholder="Search here..."
